...
import inspire.ariel.inspire.owner.quotecreator.adapters.FontsAdapter;
import inspire.ariel.inspire.owner.quotecreator.adapters.TextColorsAdapter;
import inspire.ariel.inspire.owner.quotecreator.adapters.TextSizesAdapter;
...
public class QuoteCreatorMenuFragment extends Fragment implements QuoteCreatorMenuView, QuoteCreatorMenuFragmentInjector {
    ...
    @Inject //ViewsModule
            List<QuoteMenuComponents> quoteOptionComponents;
    ...
    private void initExpandableLayouts() {
        for (QuoteMenuComponents components : quoteOptionComponents) {
